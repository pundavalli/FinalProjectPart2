...
public class Email {
    ...
    public Email(String user_name, String domain_name) {
        ...
        if (!(domain_name.contains(".com") || domain_name.contains(".net") || domain_name.contains(".fr") || domain_name.contains(".co.uk") || domain_name.contains(".gov") || domain_name.contains(".edu"))) {
